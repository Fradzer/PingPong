...
namespace PingPong
{
    public partial class Form1 : Form
    {
        ...
        public Rectangle FirstR { get; set; }
        public  Rectangle SecondR { get; set; }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Finalvideo.DesiredFrameRate = 1000;//сколько кадров в секунду. FPS
            Finalvideo.DesiredFrameSize = new Size(320, 240);//размер изображения
            Finalvideo.Start();
        }
        ...
        {
            PlayForm newPlayForm = new PlayForm(this);
            newPlayForm.Show();
        }
    }
